...
challenge1 = Challenge.create(
  name: "Transat Jacques Vabre : Traversée de l'Atlantique en double à la voile",
...
challenge2 = Challenge.create(
  name: "Vendée Globe : Traversée en solitaire du tour du monde à la voile",
...
challenge3 = Challenge.create(
  name: "Race Across America : Course à vélo transcontinentale",
...
challenge4 = Challenge.create(
  name: "Marathon des Sables : Course à pied à travers le désert",
...
challenge5 = Challenge.create(
  name: "Tour du Mont Blanc : Randonnée pédestre à travers les Alpes",
...
challenge6 = Challenge.create(
  name: "Red Bull X-Alps : Course d'aventure en parapente et randonnée",
